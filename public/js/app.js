...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_clipboard__ = __webpack_require__(4);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__shopify_draggable__ = __webpack_require__(5);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__shopify_draggable___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1__shopify_draggable__);
...
document.addEventListener("DOMContentLoaded", function () {
    ...
    // Modal
    var $modals = getAll('a[data-toggle="modal"][data-targetid], button[data-toggle="modal"][data-targetid]');
    if ($modals.length > 0) {
    ...
    var $inputFiles = getAll('input[type="file"]');
    ...
    var clipboard = new __WEBPACK_IMPORTED_MODULE_0_clipboard___default.a('.js-clipboard');
    ...
    // 請求書作成ページ
    if (document.querySelector('.invoice-create') || document.querySelector('.invoice-edit') || document.querySelector('.invoice-copy') || document.querySelector('.estimate-create') || document.querySelector('.estimate-edit') || document.querySelector('.estimate-copy')) {
        var createSortable = function createSortable(selector) {
            var $el = document.querySelectorAll(selector);
            return !$el ? null : new __WEBPACK_IMPORTED_MODULE_1__shopify_draggable__["Sortable"]($el, {
