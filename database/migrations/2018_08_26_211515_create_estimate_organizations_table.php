...
class CreateEstimateOrganizationsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('estimate_organizations', function (Blueprint $table) {
            $table->increments('id');
            ...
            $table->unique(['estimate_id', 'organization_id']);
        });
    }
    ...
    {
        Schema::dropIfExists('estimate_organizations');
    }
}
